...
- (void)viewDidLoad {
    ...
    self.regionChooseArray = [NSMutableArray arrayWithArray:@[LocalString(@"中国大陆"),LocalString(@"United Kingdom"),LocalString(@"Denmark"),LocalString(@"Netherlands"),LocalString(@"Finland"),LocalString(@"France"),LocalString(@"Germany"),LocalString(@"Italy"),LocalString(@"Norway"),LocalString(@"Russia"),LocalString(@"Portugal"),LocalString(@"Spain")]];
    //默认选择之前选中的地区
